...
public class ZkApi {
    ...
    public String createSerialNode(String path, String data) {
        try {
            return zkClient.create(path, data.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
        } catch (Exception e) {
            log.error("【创建持久化节点异常】{},{},{}", path, data, e);
            return null;
        }
     ...
     * @param data
     */
    public boolean createTempSerialNode(String path, String data) {
        try {
