...
public class DigitalToChineseUtil {
    ...
    public static String int2chineseNum(int intNum) {
        ...
        System.out.println(sb.toString().replaceAll("零[千百十]", "零"));
        System.out.println(sb.toString().replaceAll("零[千百十]", "零").replaceAll("零+万", "万"));
        System.out.println(sb.toString().replaceAll("零[千百十]", "零").replaceAll("零+万", "万"));
        System.out.println(sb.toString().replaceAll("零[千百十]", "零").replaceAll("零+万", "万")
                .replaceAll("零+亿", "亿"));
        System.out.println(sb.toString().replaceAll("零[千百十]", "零").replaceAll("零+万", "万")
    ...
    public static void main(String[] args) {
        ...
        System.out.println(int2chineseNum(1000000000));
    }
}
